 ...
 */
public class SingleLinkedListAssigned<E> implements List<E> {
     ...
     */
    public SingleLinkedListAssigned() {
        this.size = 0;
        this.head = null;
        this.tail = null;
    ...
    private class Itr implements Iterator<E> {
        ...
        private Itr() {
            ...
            this.numeroModificheAtteso = SingleLinkedListAssigned.this.numeroModifiche;
        }
        ...
        public boolean hasNext() {
            if (this.lastReturned == null)
                ...
                return SingleLinkedListAssigned.this.head != null;
            else
        ...
        public E next() {
            ...
            if (this.numeroModificheAtteso != SingleLinkedListAssigned.this.numeroModifiche) {
            ...
            if (this.lastReturned == null) {
                ...
                this.lastReturned = SingleLinkedListAssigned.this.head;
                return SingleLinkedListAssigned.this.head.item;
            } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (this == obj)
            return true;
        if (!(obj instanceof SingleLinkedListAssigned))
            return false;
        SingleLinkedListAssigned<?> other = (SingleLinkedListAssigned<?>) obj;
